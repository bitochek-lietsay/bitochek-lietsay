...
import { d as useNuxtApp, c as createError, u as useRuntimeConfig, e as useRequestEvent } from '../server.mjs';
import { withLeadingSlash, joinURL, withoutTrailingSlash } from 'ufo';
import { isEqual, hash } from 'ohash';
import { parse, serialize } from 'cookie-es';
import { appendHeader } from 'h3';
import destr from 'destr';
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-953f42e3.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-905fbf11.mjs').then((m) => m.useContentDatabase());
...
export { useCookie as a, assertArray as b, createQuery as c, ensureArray as d, encodeQueryParams as e, apply as f, get as g, withKeys as h, jsonStringify as j, queryContent as q, sortList as s, useAsyncData as u, withoutKeys as w };
//# sourceMappingURL=query-b51acd0b.mjs.map
